...
1. Open `/login` and click **"Enter demo"** in the dashed blue card → sets `localStorage.company:session = { email: "rahul@email.com", name: "Rahul Sharma" }` and navigates to `/dashboard`.
